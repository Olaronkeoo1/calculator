...
// Error handling for invalid operator/number input
operatorButtons.forEach(button => {
  button.addEventListener("click", () => {
    // If already have firstNumber and operator, and user tries to input another operator without a second number
...
// Error handling for equals with only one number
equalsButton.addEventListener("click", () => {
